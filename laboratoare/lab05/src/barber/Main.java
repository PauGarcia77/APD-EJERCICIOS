...
public class Main {
    ...
    public static Semaphore customers = new Semaphore(0); // Número de clientes esperando
    public static Semaphore barber = new Semaphore(0);    // Señal de que el barbero está listo
    public static Semaphore mutex = new Semaphore(1);     // Exclusión mutua para acceder a 'chairs'
